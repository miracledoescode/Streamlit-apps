...
def simple_job_classifier(resume_text):
    ...
    job_keywords = {
        "Software Engineer": ["programming", "software", "developer", "java", "python", "c++", "javascript", "react", "node", "backend", "frontend", "full stack"],
        "Data Scientist": ["data", "machine learning", "ml", "python", "statistics", "r", "deep learning", "analysis", "tensorflow", "pandas"],
        "Product Manager": ["product management", "roadmap", "stakeholders", "agile", "scrum", "user stories", "market research"],
        ...
        "Finance Analyst": ["finance", "accounting", "budgeting", "financial analysis", "excel", "forecasting", "audit"],
    }
